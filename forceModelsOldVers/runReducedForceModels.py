...
#from reducedForceModels import variableResistorCircuitModel
...
class runReducedModels():
    def __init__(self,t,g,NF,NC):
        ...
        print(params.L,combDriveParams.d,combDriveParams.NFingers,combDriveParams.NCombs)    
        class model:
            NormalCircuit=0
            ReducedCircuit=1
    ...
    def reducedModels(self,modelsUse,c0In0,k0,Vpp):
        ...
        VRMS = Vpp/np.sqrt(2);
        model = self.model;
        tauIn0 = calcTimeConstantOxideOnly(c0In0*100e-6,params)
        if (modelsUse == 'Classic'):
            ...
            #Cox=C0  #Dimensionless capacitance of oxide
            #Cstern=C0 #Dimensionless capacitance of Stern Layer
...
#            modelParams = (alphaOx0,alphaStern0,c0In0,k0);
            modelParams = (Cox,Cstern,c0In0,k0);
            func = combDriveModels.variableResistorCircuitModel(Vpp,params,combDriveParams,model);   
#            func = variableResistorCircuitModel(Vpp); 
#            func = variableResistorCircuitModel(Vpp,params,combDriveParams,model);  
            ...
            #alphaOx,alphaStern,ROx,c0NomIn,k
            ...
            modelParams = (alphaOx0,alphaStern0,ROx0,c0In0,k0)
